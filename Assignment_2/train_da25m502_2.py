...
import os
# =========================================================================
# ENVIRONMENT OVERRIDES FOR LOW-MEMORY ENVIRONMENTS
# =========================================================================
...
def train_evaluate_lr(config, data_train, data_val):
    """Ray Tune Objective function that handles Logistic Regression training."""
    ...
    with mlflow.start_run(nested=True) as run:
        ...
        # =========================================================================
        # PART B (SECTION 1): MODEL TRAINING - EXECUTE LOGISTIC REGRESSION
        # =========================================================================
...
def main():
    ...
    search_space = {
        ...
        "penalty": tune.choice(["l2"]),  # l2 is natively supported across all standard solvers
        "solver": tune.choice(["lbfgs", "saga"]),
        "max_iter": tune.choice([100, 200])
    }
